"""Stable Diffusion XL wrapper that adds archive-based Evo steering."""
...
try:
    from fkd_diffusers.fkd_pipeline_sdxl import FKDStableDiffusionXL, latent_to_decode
except ModuleNotFoundError:
    from fkd_pipeline_sdxl import FKDStableDiffusionXL, latent_to_decode
...
class EvoStableDiffusionXL(FKDStableDiffusionXL):
    """FKD-compatible SDXL pipeline that can run Evo guidance via `evo_args`."""

    _callback_tensor_inputs = FKDStableDiffusionXL._callback_tensor_inputs + ["x0_preds"]
